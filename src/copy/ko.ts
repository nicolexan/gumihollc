  ...
  home: {
    ...
    testimonials: {
      ...
      quotes: [
        ...
        {
          content:
            '카페인에 매우 예민한 편이라, 서서히 활력을 주는 인삼을 먹어 볼 생각에 설렜어요! 맛이 정말 좋아서, 시원하고 상큼한 음료가 당길 때면 저도 모르게 이 인삼 파우더에 손이 가요. 그냥 먹어도 전에 먹어 본 다른 인삼들보다 훨씬 맛있어요. 너무 쓰지 않고, 흙내음도 딱 적당해요. 꿀을 넣으면 단맛이 알맞게 더해져 건강 음료라기보다 간식처럼 즐기게 돼요. 벌써 다 먹었어요!',
          author: 'Nicole',
        },
      ],
      statistics: [
